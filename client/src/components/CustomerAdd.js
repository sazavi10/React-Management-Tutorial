...
class customerAdd extends Component {
    ...
    render() {
        const { fileName, userName, birthday, gender, job} = this.state;
        const { handleFormSubmit, handleFileChange, handleValueChange} = this;
        return(
            <form onSubmit={handleFormSubmit} >
                <h1>고객추가</h1>
                프로필 이미지 : <input type="file" name="file" value={fileName} onChange={handleFileChange}/><br/>
